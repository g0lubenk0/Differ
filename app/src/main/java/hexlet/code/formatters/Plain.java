        ...
        for (var key: keyList) {
            if (map1.containsKey(key) && map2.containsKey(key)) {
                ...
                if (value1 == null && value2 == null) {
                    ...
                    builder.append("Property '").append(key).append("' was updated. From ").append(value1)
                            .append(" to ").append(value2).append("\n");
                }
            } else if (map1.containsKey(key) && !map2.containsKey(key)) {
                builder.append("Property '").append(key).append("' was removed.").append("\n");
            } else {
                builder.append("Property '").append(key).append("' was added wtih value: ")
                        .append(Formatter.valueToString(map2.get(key))).append("\n");
            }
        }
        return builder;
    }
